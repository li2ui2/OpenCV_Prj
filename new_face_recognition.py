...
def main():      
    ...
    with tf.Graph().as_default():
        with tf.Session() as sess:     
            # Load the model 
            # 这里要改为自己的模型位置
            model='E:\\WorkSpace\\PycharmProject\\face_recognition_system\\20170512-110547'
            ...
            emb_dir='E:\\WorkSpace\\PycharmProject\\face_recognition_system\\Data\\emb_img2'
            all_obj=[]
            ...
            # print(compare_num)
            # dist = np.sqrt(np.sum(np.square(np.subtract(compare_emb[0, :], compare_emb[1, :]))))
            #开启ip摄像头
